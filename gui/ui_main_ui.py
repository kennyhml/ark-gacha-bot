...
"}")
        ...
        self.plot_stacks.setGeometry(QRect(150, 160, 51, 22))
...
"background-color: rgb(30, 30, 30);")
        ...
        self.label_18.setGeometry(QRect(210, 155, 91, 31))
        self.label_18.setFont(font)
        self.label_18.setStyleSheet(u"color: rgb(255, 255, 255)")
        self.label_19 = QLabel(self.tab_2)
        self.label_19.setObjectName(u"label_19")
        self.label_19.setGeometry(QRect(10, 220, 201, 31))
        ...
        self.min_pellet_coverage.setGeometry(QRect(220, 225, 51, 22))
...
"background-color: rgb(30, 30, 30);")
        ...
        self.crop_plot_turns.setGeometry(QRect(10, 290, 361, 20))
...
"")
        ...
        self.ytrap_beds.setGeometry(QRect(300, 54, 61, 22))
...
"background-color: rgb(30, 30, 30);")
        ...
        self.label_39.setGeometry(QRect(10, 190, 151, 31))
        self.label_39.setFont(font)
        self.label_39.setStyleSheet(u"color: rgb(255, 255, 255)")
        self.ytrap_plot_delay = QDoubleSpinBox(self.tab_2)
        self.ytrap_plot_delay.setObjectName(u"ytrap_plot_delay")
        self.ytrap_plot_delay.setGeometry(QRect(151, 194, 51, 22))
        self.ytrap_plot_delay.setFont(font)
        self.ytrap_plot_delay.setStyleSheet(u"border: None;\n"
"background-color: rgb(30, 30, 30);")
        self.ytrap_plot_delay.setMinimum(0.200000000000000)
        self.ytrap_plot_delay.setMaximum(2.000000000000000)
        self.ytrap_plot_delay.setSingleStep(0.100000000000000)
        self.label_62 = QLabel(self.tab_2)
        self.label_62.setObjectName(u"label_62")
        self.label_62.setGeometry(QRect(210, 190, 101, 31))
        self.label_62.setFont(font)
        self.label_62.setStyleSheet(u"color: rgb(255, 255, 255)")
        self.ytrap_gacha_turn = QSpinBox(self.tab_2)
        self.ytrap_gacha_turn.setObjectName(u"ytrap_gacha_turn")
        self.ytrap_gacha_turn.setGeometry(QRect(310, 195, 61, 22))
        self.ytrap_gacha_turn.setFont(font)
        self.ytrap_gacha_turn.setStyleSheet(u"border: None;\n"
"background-color: rgb(30, 30, 30);")
        self.ytrap_gacha_turn.setMinimum(-300)
        self.ytrap_gacha_turn.setMaximum(-140)
        self.ytrap_gacha_turn.setSingleStep(5)
        self.ytrap_gacha_turn.setValue(-140)
        self.tabWidget.addTab(self.tab_2, "")
        self.label_14.raise_()
        self.label_15.raise_()
        self.mode.raise_()
        self.turn_direction.raise_()
        self.label_16.raise_()
        self.plot_stacks.raise_()
        self.label_17.raise_()
        self.plots_per_stack.raise_()
        self.label_18.raise_()
        self.label_19.raise_()
        self.min_pellet_coverage.raise_()
        self.label_20.raise_()
        self.label_22.raise_()
        self.label_87.raise_()
        self.auto_level_gachas.raise_()
        self.label_41.raise_()
        self.ytrap_prefix.raise_()
        self.label_42.raise_()
        self.ytrap_beds.raise_()
        self.ytrap_enabled.raise_()
        self.crop_plot_turns.raise_()
        self.label_39.raise_()
        self.ytrap_plot_delay.raise_()
        self.label_62.raise_()
        self.ytrap_gacha_turn.raise_()
        self.tab_3 = QWidget()
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_39.setText(QCoreApplication.translate("Form", u"Open/close delay:", None))
        self.label_62.setText(QCoreApplication.translate("Form", u"Gacha turn:", None))
